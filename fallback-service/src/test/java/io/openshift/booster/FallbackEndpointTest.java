...
import io.openshift.booster.service.FallbackController;
...
public class FallbackEndpointTest {
    ...
    public void testGetName() {
        RestAssured.when().get("name").then().assertThat().statusCode(200).body(equalTo(FallbackController.theName));
    }
